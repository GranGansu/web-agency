...
export default function Benefits(){
    return <div className="flex flex-col items-center justify-center bg-gray-900 text-white py-16 from-black to-gray-800 bg-gradient-to-b w-full gap-x-4" style={{translate:'x',zIndex:888}}>
