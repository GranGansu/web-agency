...
export default function BrowserMockup({ children, title }) {
...
{/*         <span className='ml-2 material-icons rounded-full relative text-white p-1 bg-green-500 ' style={{ fontSize: '20px' }}>
      ...
      <motion.div
        ...
        initial={{ scale: 0.8 }}
        className='border-2 hover:opacity-100  skew-x-1 shadow-xl bg-rainbgow aspect-[4/3] bg-gray-100 relative border-gray-300 rounded-2xl w-full opacity-100'>
        <Absolute className='z-50 left-1/2 top-1/2 hidden'>
