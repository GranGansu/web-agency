...
export default function PhoneMockup({ children, absolute }) {
  ...
  return (
    ...
    style={{transformStyle:'preserve-3d'}}
      ...
      initial={{ scale: 0.8 }}
      className={`border-2 border-black/80 hover:opacity-100 shadow-2xl  aspect-[6/9] bg-gray-100 rounded-full sm:rounded-[15px] w-full opacity-100 overflow-hidden flex flex-col relative`}
    >
