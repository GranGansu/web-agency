...
export default function Header() {
  ...
  return (
    <div className={'sm:max-w-6xl m-auto mt-0 bg-white/10 shadow px-2 text-white rounded-b-xl mb-8'}>
      <div className='p-0 mt-0 text-center w-full'>
        <ul className='sm:space-x-4 gap-x-6 sm:gap-x-4 sm:space-y-0 flex sm:flex-row text-md sm:text-xl justify-center font-bold p-4 items-center sm:items-center uppercase border-gray-900 mb-4  w-full'>
          <li className='hidden'>
